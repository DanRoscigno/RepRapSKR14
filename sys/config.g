...
M550 P"office3d"                               ; set printer name

; Network
M551 P"catch22"                                ; set password
...
M92 X80.00 Y80.00 Z400.00 E103.50              ; set steps per mm
...
G31 P500 X-41.8 Y0 Z4.35                       ; set Z probe trigger value, offset and trigger height
M557 X5:200 Y25:220 S20                        ; define mesh grid
